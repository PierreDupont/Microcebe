...
N0 <- 50                                          ## Initialize population size       
n.years <- 4                                      ## Number of years simulated
...
## And check the posterior effective sample size (ESS) resulting from our 15 000 posterior samples for the parameters we tracked ( $\phi$, $\delta$, $h$, $\tau$, and $p$):  
